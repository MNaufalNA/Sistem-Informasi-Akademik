  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-purple navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url(); ?>app/registrasi" target="_blank"> <i class="fas fa-spin fa-globe text-white"></i></a>
        </li>
      </ul>
      <ul class="animated fadeInDown navbar-nav ml-auto">
      <div class="btn-group btn-group-sm">
                    <span class="btn bg-info icon text-white-50">
                  ...
                  <a href="<?php echo base_url(); ?>logout" class="btn bg-danger btn-icon-split">
