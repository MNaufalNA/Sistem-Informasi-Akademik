  ...
  <aside class="main-sidebar sidebar-light-info elevation-4 animated fadeInLeft">
    ...
    <a href="<?php echo base_url(); ?>" class="brand-link ">
     <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/upload/'.$sekolah->logo; ?>" alt="Logo" class="brand-image img-rounded elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="text-shadow: 2px 2px 4px #827e7e;"><b>ADMIN PPDB</b></span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>siswa" class="nav-link">
              <i class="nav-icon far fa-clipboard-user text-danger"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>kelulusan" class="nav-link">
              <i class="nav-icon far fa-clipboard-user text-danger"></i>
		  ...
		  <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>banner" class="nav-link">
              <i class="nav-icon fas fa-image-polaroid text-pink"></i>
              <p>
               BANNER
              </p>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>pengaturan" class="nav-link">
              <i class="nav-icon fas fa-cogs text-navy"></i>
              <p>
               PENGATURAN
              </p>
            </a>
