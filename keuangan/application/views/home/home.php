        ...
        <div class="row mb-2">
          <div class="col-sm-12 mt-1">
            <div class="card card-info card-outline">
              <center><h1 class="m-0 text-dark" style="text-shadow: 2px 2px 4px #17a2b8;"><i class="fal fa-desktop-alt mt-2"></i> <br>DAFTAR LAYOUT INFORMASI KEUANGAN</h1> </center>
              <hr>
                <div class="container-fluid">
                <div class="row">
                  <!-- DATA KELAS -->
                  <div class="col-md-8">
                    <div class="card card-info card-outline animated fadeInLeft">
                      <div class="card-header">
                        <h3 class="card-title text-info" style="text-shadow: 2px 2px 4px #black;"><i class="fas fa-hand-holding-usd nav-icon text-info"></i> Riwayat Transaksi Terakhir</h3>
