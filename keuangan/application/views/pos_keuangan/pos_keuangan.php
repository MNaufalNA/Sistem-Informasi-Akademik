        ...
        <div class="animated fadeInLeft col-md-8">
            <div class="card card-info card-outline">
              <div class="card-header">
               <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>master/pos_keuangan_tambah"><i class="fa fa-plus"> </i> Tambah Data</a>
              ...
              <div class="card-body table-responsive p-2">
                <table id="datatb" class="table table-bordered table-hover table-striped">
                  ...
                  <tbody>
                    <?php
                  $no = 1;
                  foreach($pos_keuangan->result_array() as $data) { ?>
                    <tr>
                      <td><?php echo $no; ?></td>
                      <td><?php echo $data['nama_pos_keuangan']; ?></td>
                      <td style="text-align:center;"><?php
                            if($data['aktif_pos_keuangan'] == '1') {
                      ...
                      <td style="text-align:center;">
                        <a class="btn btn-danger btn-xs" href="<?php echo base_url().'master/pos_keuangan_edit/'.$data['id_pos_keuangan']; ?>"><i class="fa fa-edit"> </i> Edit</a>
                      </td>
                    </tr>
                  <?php $no++; } ?>
                  </tbody>
