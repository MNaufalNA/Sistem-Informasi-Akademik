      ...
      <div class="container-fluid">
        ...
        <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>master/pos_keuangan_save" method="post">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <input type="hidden" name="id_pos_keuangan" value="<?php echo $id_pos_keuangan; ?>">
                    <input type="text" class="form-control" name="nama_pos_keuangan" value="<?php echo $nama_pos_keuangan; ?>" required>
                    </div>
                  </div>
                    <div class="form-group row">
                    <label  class="col-sm-3 col-form-label">Status Pembayaran</label>
                    <div class="col-sm-12">
                    <select class="form-control select2" name="aktif_pos_keuangan"  required>
                        <option value="1" <?php if($aktif_pos_keuangan == '1') echo 'selected'; ?>>AKTIF</option>
                        <option value="0" <?php if($aktif_pos_keuangan == '0') echo 'selected'; ?>>TIDAK AKTIF</option>
                    </select>
                    </div>
                </div>
                </div>
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>master/pos_keuangan"><i class="fa fa-undo"> </i> Kembali</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
