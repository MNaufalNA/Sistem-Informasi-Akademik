        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#s"><?php echo $judul; ?></a></li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="animated lightSpeedIn col-md-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               ...
               <a class="btn bg-danger btn-sm" href="<?php echo base_url(); ?>das/das_bendahara"><i class="fa fa-arrow-left"> </i> Kembali</a>
                        <?php if ($status == 0) { ?>
                ...
                <table class="table">
                  ...
                  <table id="datatb" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($das_user_bendahara->result_array() as $data) { ?>
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        ...
                                        <td style="text-align:center;">
                                            <div class="btn-group btn-group-sm">
                                            <a class="btn bg-info btn-xs lihat-das-user" href="<?php echo base_url().'das/das_bendahara_kelola/'.$data['id_das_user_bendahara']; ?>" ><i class="fab fa-elementor"></i> Detail</a>
                                            <?php if ($status == 0 && $data['status_das_user'] == 0) { ?>
                                                <a class="btn bg-navy btn-xs" href="<?php echo base_url() . 'das/das_user_bendahara_tutup/' . $data['id_das_user_bendahara'] . '/' . $data['id_das_bendahara']; ?>" onclick="return confirm('Yakin ingin menutup DAS ini ?');"><i class="fad fa-lock-alt"></i> Tutup</a>

                                                <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'das/das_user_bendahara_hapus/' . $data['id_das_user_bendahara'] . '/' . $data['id_das_bendahara']; ?>"><i class="fa fa-trash"> </i> Hapus</a>
                                            </div>
                                            <?php } ?>
                                        </td>
                                    </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="info"></div>
        <form role="form" action="<?php echo base_url(); ?>das/das_user_bendahara_save" method="post">
                    <input class="id_das_bendahara" type="hidden" name="id_das_bendahara" value="<?php echo $id_das_bendahara; ?>" readonly>
                   ...
                   <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control text-right " onkeypress="return hanyaAngka(event)" name="total_terima" required>
                    </div>
                    </div>
