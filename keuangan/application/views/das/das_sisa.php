        ...
        <form role="form" action="<?php echo base_url(); ?>das/das_sisa_save" method="post">
                    ...
                    <div class="input-group">
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="dana"  value="" required="">
                    </div>
                    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
              <h4 class="modal-title">Tambah Sisa RABS</h4>
        ...
        <form role="form" action="<?php echo base_url(); ?>das/das_sisa_save" method="post">
                    ...
                    <div class="input-group">
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control " name="dana"  value="" required="">
                    </div>
                    </div>
