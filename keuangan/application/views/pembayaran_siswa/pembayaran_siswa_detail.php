...
<div class="modal fade" id="modalAdd">
        <div class="modal-dialog">
          <div class="modal-content bg-teal">
            ...
            <div class="modal-body">
              <div id="info"></div>
        <form role="form" action="<?php echo base_url(); ?>pembayaran/pembayaran_bulanan_save" method="post" onsubmit="return cek_bayar(this);">
          ...
          <div class="form-group">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-outline-light bg-navy btn-block"><i class="nav-icon fas fa-money-check-alt text-white"> </i> Lakukan Bayar</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
      ...
      <div class="modal fade" id="modalAdsd">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-success"><i class="nav-icon fas fa-money-check-alt text-white"> </i> Lakukan Pembayaran</button>
        </form>
      </div>
    </div>
    <!-- /.modal-content -->
