        ...
        <div class="row mb-2">
          <div class="col-sm-8 mt-2">
            <h5 class="m-0 text-dark" >
              ...
              <div class="btn-group btn-group-sm"><a href="#" class="btn btn-info btn-icon-split" style="text-shadow: 2px 2px 4px black;"><b>'.$nama_pos_keuangan.'</b> </a> <a href="#" class="btn btn-danger btn-icon-split" style="text-shadow: 2px 2px 4px black;"><b>TP. '.$tahun_ajaran.'</b></a> <a href="#" class="btn btn-warning btn-icon-split text-uppercase" style="text-shadow: 2px 2px 4px white;"><b>('.$tipe_pembayaran.')</b></a></div>'; ?></h5>
          </div><!-- /.col -->
          <div class="col-sm-4">
      ...
      <div class="container-fluid">
        ...
        <div class="animated fadeInUp col-md-5">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>master/tarif_kelas_save" method="post">
