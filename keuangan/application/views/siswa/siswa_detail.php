        ...
        <div class="row mb-2" id="cetak">
          <div class="col-sm-12 mt-2">
            <div class="card">
              ...
              <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/asisv3/asispanel/upload/logo.png'; ?>" alt="Logo" class="brand-image img-rounded " style="width:50px;height:50px;">
              <br><?php echo $namasekolah ?></h1>
              <?php echo $alamatsekolah; ?><br>
          ...
          <div class="card-footer mb-2">
                  <button class="btn btn-success float-right ml-2" onclick="printDiv('cetak')"><i class="fa fa-print" target="_blank" > </i> Cetak</button>
