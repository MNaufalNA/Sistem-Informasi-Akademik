...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo 'http://' . $_SERVER['SERVER_NAME'] . '/logo.png'; ?>" type="image/x-icon">
    ...
    <nav class="main-header navbar navbar-expand navbar-info navbar-light">
      ...
      <ul class="animated fadeInDown navbar-nav ml-auto">
        <a href="#" class="btn btn-danger btn-icon-split">
          ...
          <span class="brand-text font-weight-light text-white"><b>Tahun Ajaran : <?php echo $tahun_ajaran->tahun_ajaran . ' | Semester ' . $tahun_ajaran->semester; ?></b></span>
        </a>
      </ul>
