        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>master/buku"><?php echo $judul; ?></a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>master/buku_save" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="total_halaman" value="<?php echo $total_halaman; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Tinggi Buku</label>
                                        <input type="text" class="form-control" name="tinggi_buku" value="<?php echo $tinggi_buku; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jumlah_buku" value="<?php echo $jumlah_buku; ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php if (!empty($foto_buku)) { ?>
                                            <img src="<?php echo base_url() . 'upload/buku/' . $foto_buku; ?>" style="width:100px;height:100px;">
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-footer text-right">
                    ...
                    <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>master/buku"><i class="fa fa-undo"> </i> Kembali</a>
