      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="image">
         ...
         <?php } else { ?>
          ...
          <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/upload/user.jpg'; ?>" class="img-rounded elevation-2" style="width:60px;height:70px;" alt="Foto Admin">
        </div>
        <?php } ?>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="<?php echo base_url(); ?>" class="nav-link active bg-navy">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>pengaturan/denda" class="nav-link">
              <i class="nav-icon fas fa-sliders-v-square text-navy"></i>
              <p>
                Pengaturan Denda
              </p>
            </a>
