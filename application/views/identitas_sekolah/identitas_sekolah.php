      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 mt-2">
            <h1 class="m-0 text-dark" style="text-shadow: 2px 2px 4px gray;"><i
                class="nav-icon fas fa-school text-info"></i> <?php echo $judul; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#"><i class="nav-icon fas fa-school text-info"></i> Data</a></li>
              <li class="breadcrumb-item"><a
                  href="<?php echo base_url(); ?>master/identitas_sekolah_save"><?php echo $judul; ?></a></li>
        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft   col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>master/identitas_sekolah_save"
                    ...
                    <div class="col-sm-4">
                      <div class="card card-info">
                        ...
                        <div class="card-body">
                          ...
                          <?php
if (!empty($logo)) {
    echo '<center><img id="file-ip-1-preview" style="width:150px;150px;" src="' . base_url() . 'upload/' . $logo . '" class="img-responsive img-thumbnail"></center>';
}
?>
                        </div>
                      </div>
                      ...
                      <div class="card card-info">
                        ...
                        <div class="input-group mt-2 mb-2">
                          <div class="custom-file ml-2 mr-2">
                            <input type="file" name="logo" id="file-ip-1" accept="image/*"
                              onchange="showPreview(event);" class="custom-file-input form-control">
                            <label id="file-label" class="custom-file-label" for="file-ip-1">Cari file..</label>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="index.php"><button type="button" class="btn btn-danger"><i class="fa fa-undo (alias)"></i> B
                      A T A L</button></a>
                </div>
                <!-- /.card-footer -->
              </form>
          ...
          <div class="animated fadeInRight col-md-4 ">
            <div class="callout callout-info">
              ...
              <p>
                Untuk <b>Keterangan</b> dan <b>Informasi</b> lebih lanjut silahkan hubungi <b>Bagian IT (Information
                  &amp; Technology)</b>
              </p>
...
function showPreview(event) {
  if (event.target.files.length > 0) {
    ...
    // console.log(fileLabel.textContent = files[0].name);
