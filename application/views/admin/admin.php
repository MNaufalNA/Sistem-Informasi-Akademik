          ...
          <div class="animated fadeInUp col-12">
            <div class="card card-info card-outline">
              <div class="card-header">
                <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>user/admin_tambah"><i class="fa fa-plus">
                  </i> Tambah Data</a>
              </div>
              <!-- /.card-header -->
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;">
                        <a class="btn btn-info btn-xs"
                          href="<?php echo base_url() . 'user/admin_edit/' . $data['id_user']; ?>"><i
                            class="fa fa-edit">
                          </i> </a>
                        <a class="btn btn-danger btn-xs"
                          href="<?php echo base_url() . 'user/admin_hapus/' . $data['id_user']; ?>"
