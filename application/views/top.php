...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo 'http://' . $_SERVER['SERVER_NAME'] . '/upload/' . $sekolah->logo; ?>"
    type="image/x-icon">
    ...
    <nav class="main-header navbar navbar-expand navbar-info navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
            <span class="dropdown-item dropdown-header">UPDATE ASIS</span>
      ...
      <ul class="animated fadeInDown navbar-nav ml-auto">
        <div class="btn-group btn-group-sm">
          ...
          <span class="btn bg-warning brand-text font-weight-light text-white text-uppercase"><b>TP :
              <?php echo $tahun_ajaran->tahun_ajaran . ' | Semester ' . $tahun_ajaran->semester; ?></b></span>
