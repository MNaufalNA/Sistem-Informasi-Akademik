...
?>
  ...
  <aside class="main-sidebar sidebar-light-info elevation-4 animated fadeInLeft">
    ...
    <a href="<?php echo base_url(); ?>" class="brand-link ">
      <img src="<?php echo base_url() . '/upload/' . $sekolah->logo; ?>" alt="ASIS LOGO"
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          ...
          <a href="<?php echo base_url(); ?>logout"><span class="badge badge-danger right ">Logout <i
                class="nav-icon fas fa-sign-out-alt"></i></span></a>
        </div>
...
echo date('Y'); ?></span>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
          ...
          <li class="nav-item has-treeview <?php if ($this->uri->segment(1) == 'user') {
    echo 'active';
}
?> treeview <?php if ($this->uri->segment(1) == 'user') {
    echo 'menu-open';
}
?>">
