            ...
            <div class="card card-info">
              ...
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>admin/update" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-3 col-form-label">No WA</label>
                    <div class="col-sm-12">
                      <input type="number" class="form-control" name="no_wa" value="<?php echo $no_wa; ?>" required
                        placeholder="62898198">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>user/admin"><i
