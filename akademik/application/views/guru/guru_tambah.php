    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-success">
          <form role="form" action="<?php echo base_url(); ?>pengguna/guru_save" method="post"
                ...
                <div class="col-xs-12">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="aktif_guru">
                      <option value="1" <?php if ($aktif_guru == '1') {
    echo 'selected';
}
?>>AKTIF</option>
                      <option value="0" <?php if ($aktif_guru == '0') {
    echo 'selected';
}
?>>TIDAK AKTIF</option>
                    </select>
            ...
            <div class="box-footer text-center">
              ...
              <a class="btn btn-default btn-lg" href="<?php echo base_url(); ?>pengguna/guru"><i
