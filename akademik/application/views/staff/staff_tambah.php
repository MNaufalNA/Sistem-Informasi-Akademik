<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>pengguna/staff"><?php echo $judul; ?></a></li>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <form role="form" action="<?php echo base_url(); ?>pengguna/staff_save" method="post"
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_staff" value="<?php echo $nama_staff; ?>"
                      required>
                  </div>
                </div>
                ...
                <div class="col-xs-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control tgl" name="tanggal_lahir"
                      value="<?php echo $tanggal_lahir; ?>" placeholder="dd-mm-yyyy" required>
                  </div>
                </div>
                <div class="col-xs-6">
                  <div class="form-group">
                ...
                <div class="col-xs-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="kewarganegaraan" required>
                      <option value>PILIH</option>
                      <option value="WNI" <?php if ($kewarganegaraan == 'WNI') {
    echo 'selected';
}
?>>WNI</option>
                      <option value="WNA" <?php if ($kewarganegaraan == 'WNA') {
    echo 'selected';
}
?>>WNA</option>
                    </select>
                ...
                <div class="col-xs-4">
                  <div class="form-group">
                    <label>Status</label>
                    <select class="form-control" name="aktif_staff" required>
                      <option value="1" <?php if ($aktif_staff == '1') {
    echo 'selected';
}
?>>AKTIF</option>
                      <option value="0" <?php if ($aktif_staff == '0') {
    echo 'selected';
}
?>>TIDAK AKTIF</option>
                    </select>
              ...
              <div class="row">
                <div class="col-xs-4">
                  <div class="form-group">
                    ...
                    <?php if (!empty($foto)) {?>
                    <img src="<?php echo base_url() . 'upload/staff/' . $foto; ?>" style="width:100px;height:100px;">
                    <?php }?>
                  </div>
                </div>
                <div class="col-xs-4">
            ...
            <div class="box-footer text-center">
              ...
              <a class="btn btn-default btn-lg" href="<?php echo base_url(); ?>pengguna/staff"><i
