      ...
      <div class="row">
			<div class="col-xs-12">
                ...
                <div class="box-body box-profile">
					      ...
					      <?php } ?>
                    <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url().'upload/staff/'.$foto; ?>" alt="<?php echo $nama_staff; ?>">
                    <table id="datatb" class="table table-bordered table-hover">
                        ...
                        <tr>
                            <td style="font-weight:bold;">Nama staff</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php if($aktif_staff == '1') echo 'AKTIF'; else echo 'TIDAK AKTIF'; ?></td>
                        </tr>
                    </table>
                    <a href="<?php echo base_url().'pengguna/staff_edit/'.$id_staff; ?>" class="btn btn-success btn-block"><b><i class="fa fa-edit"> </i> Ubah Data</b></a>

                    <a href="<?php echo base_url().'pengguna/staff/'; ?>" class="btn btn-default btn-block"><b><i class="fa fa-arrow-left"> </i> Kembali</b></a>
                </div>
                </div>
                <!-- /.box -->
            </div>
