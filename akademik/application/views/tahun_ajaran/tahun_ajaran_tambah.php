<div class="content-wrapper">
	...
	<section class="content">
      ...
      <div class="row">
			<div class="col-xs-12">
                <div class="box">
                    <form role="form" action="<?php echo base_url(); ?>master/tahun_ajaran_save" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control tahun_ajaran" name="tahun_ajaran" value="<?php echo $tahun_ajaran; ?>" placeholder="Contoh : 2017/2018" required>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="form-group">
                        ...
                        <div class="box-footer text-center">
                            ...
                            <a class="btn btn-success btn-lg" href="<?php echo base_url(); ?>master/tahun_ajaran"><i class="fa fa-arrow-left"> </i> Kembali</a>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
