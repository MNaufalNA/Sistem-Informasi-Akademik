      ...
      <div class="row">
          ...
          <div class="box">
			<div class="box-header">
                <div class="row">
                     <div class="col-xs-3">
                        <a class="btn btn-default btn-sm" href="<?php echo base_url(); ?>nilai/nilai_prestasi"><i class="fa fa-arrow-left"> </i> Kembali</a>
                    </div>
            ...
            <div class="box-body">
              <table id="data-edit" class="table table-bordered">
                ...
                <tbody>
					...
					<tr id="<?php echo $data['id_nilai_prestasi']; ?>">
                        <td><?php echo $no; ?></td>
						<td><?php echo $data['nis']; ?></td>
						<td><?php echo $data['nama_siswa']; ?></td>
						<td><?php echo $data['kegiatan']; ?></td>
                        <td><?php echo $data['keterangan']; ?></td>
                        <td style="display:none;"><?php echo $data['id_nilai_prestasi']; ?></td>
                    </tr>
				    <?php  $no++; } ?>
...
$('#data-edit').Tabledit({
    ...
    editButton: false,      
    columns: {
      identifier: [5, 'id_nilai_prestasi'],                    
      editable: [[3, 'kegiatan'],[4, 'keterangan']]
    },
    hideIdentifier: true,
    url: '<?php echo base_url(); ?>nilai/nilai_prestasi_save',
