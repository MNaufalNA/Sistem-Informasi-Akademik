<div class="content-wrapper">
	...
	<section class="content">
      ...
      <div class="row">
			<div class="col-xs-12">
                <div class="box">
                    <form role="form" action="<?php echo base_url(); ?>master/walikelas_save" method="post">
                        ...
                        <input type="hidden" name="id_walikelas" value="<?php echo $id_walikelas; ?>">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-xs-12">
                        ...
                        <div class="box-footer text-center">
                            ...
                            <a class="btn btn-default btn-lg" href="<?php echo base_url(); ?>master/walikelas"><i class="fa fa-arrow-left"> </i> Kembali</a>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
