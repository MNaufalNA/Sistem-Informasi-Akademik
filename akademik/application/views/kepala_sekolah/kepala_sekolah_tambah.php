<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <form role="form" action="<?php echo base_url(); ?>pengguna/kepala_sekolah_save" method="post"
                ...
                <div class="col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_kepala_sekolah"
                      value="<?php echo $nama_kepala_sekolah; ?>" required>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-xs-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="hp" placeholder="62987976"
              ...
              <div class="row">
                <div class="col-xs-6">
                  <div class="form-group">
                    ...
                    <?php if (!empty($foto)) {?>
                    <img src="<?php echo base_url() . 'upload/kepala_sekolah/' . $foto; ?>"
                ...
                <div class="col-xs-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="aktif_kepala_sekolah" required>
                      <option value="1" <?php if ($aktif_kepala_sekolah == '1') {
    echo 'selected';
}
?>>AKTIF</option>
                      <option value="0" <?php if ($aktif_kepala_sekolah == '0') {
    echo 'selected';
}
?>>TIDAK AKTIF</option>
                    </select>
            ...
            <div class="box-footer text-center">
              ...
              <a class="btn btn-success btn-lg" href="<?php echo base_url(); ?>pengguna/kepala_sekolah"><i
