<div class="content-wrapper">
	...
	<section class="content">
      ...
      <div class="row">
			<div class="col-xs-12">
                <div class="box">
                    <form role="form" action="<?php echo base_url(); ?>master/jurusan_save" method="post">
                        ...
                        <div class="box-footer text-center">
                            ...
                            <a class="btn btn-success btn-lg" href="<?php echo base_url(); ?>master/jurusan"><i class="fa fa-arrow-left"> </i> Kembali</a>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
