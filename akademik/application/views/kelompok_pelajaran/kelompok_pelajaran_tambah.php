<div class="content-wrapper">
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>master/kelompok_pelajaran"><?php echo $judul; ?></a></li>
	...
	<section class="content">
      ...
      <div class="row">
			<div class="col-xs-12">
                <div class="box">
                    <form role="form" action="<?php echo base_url(); ?>master/kelompok_pelajaran_save" method="post">
                        ...
                        <div class="box-footer text-center">
                            ...
                            <a class="btn btn-success btn-lg" href="<?php echo base_url(); ?>master/kelompok_pelajaran"><i class="fa fa-arrow-left"> </i> Kembali</a>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
