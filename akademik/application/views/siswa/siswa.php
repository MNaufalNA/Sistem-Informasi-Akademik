          ...
          <div class="box-header">
            <div class="row">
              <div class="col-xs-4">
                <form role="form" action="<?php echo base_url(); ?>siswa/proses_tampil_siswa" method="post">
                  <div class="row">
                    ...
                    <div class="col-xs-6">
                      <button class="btn btn-primary" name="tampil"><i class="fa fa-search"> </i> Tampilkan
                        Data</button>
                    </div>
                  </div>
                </form>
              ...
              <div class="col-xs-8 text-right">
                <a class="btn btn-primary" href="<?php echo base_url() . 'siswa/siswa_export/' . $id_kelas; ?>"
                  target="_blank"><i class="fa fa-download"> </i> Export Ke Excel</a>
                <a class="btn btn-warning" href="#" data-toggle="modal" data-target="#modalAdd"><i class="fa fa-upload">
                  </i> Import Dari Excel</a>
                <a class="btn btn-danger" href="<?php echo base_url(); ?>siswa/siswa_tambah"><i class="fa fa-plus"> </i>
                  Tambah Data</a>
              </div>
            </div>
          </div>
...
if (!empty($siswa)) {
    ...
    foreach ($siswa->result_array() as $data) {?>
                <tr>
                  ...
                  <td><?php if (!empty($data['tanggal_lahir'])) {
        ...
        ?>
                  ...
                  <td style="text-align:center;">
                    <a class="btn btn-primary btn-xs"
                      href="<?php echo base_url() . 'siswa/siswa_detail/' . $data['nis']; ?>"><i class="fa fa-search">
                      </i> Detail</a>
                    <a class="btn btn-danger btn-xs"
                      href="<?php echo base_url() . 'siswa/siswa_edit/' . $data['id_siswa']; ?>"><i class="fa fa-edit">
                      </i> Ubah</a>
                  </td>
                </tr>
                <?php $no++;}?>
      ...
      <div class="modal-body">
        ...
        <form role="form" action="" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <a href="<?php echo base_url(); ?>upload/siswa_import.xls" target="_blank"
              style="color:#000;text-decoration:underline;font-weight:bold;">Format file dapat didownload disini</a>
          </div>
      </div>
