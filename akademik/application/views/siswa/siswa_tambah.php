                    ...
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control tgl" name="tanggal_lahir"
                            value="<?php echo $tanggal_lahir; ?>" placeholder="dd-mm-yyyy">
                        </div>
                      </div>
                      <div class="col-xs-12">
                        <div class="form-group">
                      ...
                      <div class="col-xs-12">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="agama">
                            ...
                            <option value="Protestan" <?php if ($agama == 'Protestan') echo 'selected'; ?>>Protestan
                            </option>
                            <option value="Budha" <?php if ($agama == 'Budha') echo 'selected'; ?>>Budha</option>
                            <option value="Hindu" <?php if ($agama == 'Hindu') echo 'selected'; ?>>Hindu</option>
                            <option value="Konghucu" <?php if ($agama == 'Konghucu') echo 'selected'; ?>>Konghucu
                            </option>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" placeholder="62987976" name="hp"
                            value="<?php echo $hp; ?>">
                        </div>
                      </div>
                      <div class="col-xs-12">
                      ...
                      <div class="col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nama_sekolah"
                            value="<?php echo $nama_sekolah; ?>">
                        </div>
                        <div class="form-group">
                          <label>Status Sekolah</label>
                          <select class="form-control" name="status_sekolah">
                            <option value>PILIH</option>
                            <option value="SWASTA" <?php if($status_sekolah == 'SWASTA') echo 'selected'; ?>>SWASTA
                            </option>
                            <option value="NEGERI" <?php if($status_sekolah == 'NEGERI') echo 'selected'; ?>>NEGERI
                            </option>
                          </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="pendidikan_ayah">
                            ...
                            <option value="Tidak Sekolah"
                              <?php if($pendidikan_ayah == 'Tidak Sekolah') echo 'selected'; ?>>Tidak Sekolah</option>
                            ...
                            <option value="DIPLOMA" <?php if($pendidikan_ayah == 'DIPLOMA') echo 'selected'; ?>>DIPLOMA
                            </option>
                      ...
                      <div class="col-xs-12">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="pendidikan_ibu">
                            <option value>PILIH</option>
                            <option value="Tidak Sekolah"
                              <?php if($pendidikan_ibu == 'Tidak Sekolah') echo 'selected'; ?>>Tidak Sekolah</option>
                            ...
                            <option value="DIPLOMA" <?php if($pendidikan_ibu == 'DIPLOMA') echo 'selected'; ?>>DIPLOMA
                            </option>
                      ...
                      <div class="col-xs-12">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="pendidikan_wali">
                            <option value>PILIH</option>
                            <option value="Tidak Sekolah"
                              <?php if($pendidikan_wali == 'Tidak Sekolah') echo 'selected'; ?>>Tidak Sekolah</option>
                            ...
                            <option value="DIPLOMA" <?php if($pendidikan_wali == 'DIPLOMA') echo 'selected'; ?>>DIPLOMA
                            </option>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="pekerjaan_wali"
                            value="<?php echo $pekerjaan_wali; ?>">
                        </div>
                        <div class="form-group">
                          <label>No Handphone</label>
                          <input type="number" class="form-control" name="no_hp_wali"
                            value="<?php echo $no_hp_wali; ?>">
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="col-xs-3">
          <div class="box box-success">
            <div class="box-body">
              <div class="form-group">
                <label>Status</label>
                <select class="form-control" name="aktif_siswa">
              ...
              <button style="width:100%;margin-bottom:5px;" type="submit" class="btn btn-success"><i class="fa fa-save">
                </i> Simpan </button>
              <a style="width:100%" class="btn btn-danger" href="<?php echo base_url(); ?>siswa/siswa"><i
