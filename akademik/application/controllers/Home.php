    ...
    public function index()
    {
        if ($this->session->userdata('hak_akses') != "") {
            ...
            if ($this->session->userdata('hak_akses') == "guru") {
                $hitung_izin = $this->db->query("SELECT COUNT(*) as hitung FROM absen WHERE keterangan = 'IZIN' AND id_tahun_ajaran = '$get_tahun->id_tahun_ajaran'")->row();

                $hitung_sakit = $this->db->query("SELECT COUNT(*) as hitung FROM absen WHERE keterangan = 'SAKIT' AND id_tahun_ajaran = '$get_tahun->id_tahun_ajaran'")->row();

                $hitung_alpa = $this->db->query("SELECT COUNT(*) as hitung FROM absen WHERE keterangan = 'ALPA' AND id_tahun_ajaran = '$get_tahun->id_tahun_ajaran'")->row();
                ...
                $hitung_izin = $this->db->query("SELECT COUNT(*) as hitung FROM absen WHERE keterangan = 'IZIN' AND id_tahun_ajaran = '$get_tahun->id_tahun_ajaran' AND id_siswa = '$id'")->row();

                $hitung_sakit = $this->db->query("SELECT COUNT(*) as hitung FROM absen WHERE keterangan = 'SAKIT' AND id_tahun_ajaran = '$get_tahun->id_tahun_ajaran' AND id_siswa = '$id'")->row();

                $hitung_alpa = $this->db->query("SELECT COUNT(*) as hitung FROM absen WHERE keterangan = 'ALPA' AND id_tahun_ajaran = '$get_tahun->id_tahun_ajaran' AND id_siswa = '$id'")->row();
