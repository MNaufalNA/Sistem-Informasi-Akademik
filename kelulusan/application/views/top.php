...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/asispanel/upload/'.$sekolah->logo; ?>">
  <!-- Font Awesome Icons -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-info navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url(); ?>portal" target="_blank"> <i class="fas fa-spin fa-globe text-white"></i></a>
        </li>
    </ul>
