  ...
  <aside class="main-sidebar sidebar-light-info elevation-4 animated fadeInLeft">
    ...
    <a href="<?php echo base_url(); ?>" class="brand-link ">
     <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/upload/'.$sekolah->logo; ?>" alt="Logo" class="brand-image img-rounded elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="text-shadow: 2px 2px 4px #827e7e;"><b>APP BUKU TAMU</b></span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>tamu" class="nav-link">
              <i class="fal fa-book-reader nav-icon text-info"></i>
              <p>
                Daftar Buku Tamu
              </p>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>agenda" class="nav-link">
              <i class="far fa-sticky-note nav-icon text-danger"></i>
              <p>
                Daftar Agenda
              </p>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>video" class="nav-link">
              <i class="nav-icon fas fa-tv-music text-purple"></i>
              <p>
                Video Display
              </p>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>katamutiara" class="nav-link">
              <i class="nav-icon fas fa-quote-left text-success"></i>
              <p>
                Kata Mutiara
              </p>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url(); ?>sholat" class="nav-link">
              <i class="nav-icon far fa-mosque  text-pink"></i>
              <p>
               Jadwal Sholat
              </p>
            </a>
