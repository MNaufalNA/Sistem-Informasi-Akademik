...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 11, 2025 at 10:37 AM
...
INSERT INTO `absen` (`id_absen`, `id_siswa`, `id_kelas`, `id_tahun_ajaran`, `keterangan`, `alasan`, `id_guru`, `tanggal_absen`) VALUES
(1, 2, 1, 4, 'IZIN', 'pergi', NULL, '2025-01-08');
...
(167, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 13:21:35'),
(168, 'Admin PPDB', '::1', 'admin', '2025-01-06 14:24:50'),
(169, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 14:25:15'),
(170, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 14:32:46'),
(171, 'Admin Akademik', '::1', 'adminakademik', '2025-01-06 14:38:47'),
(172, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 14:39:42'),
(173, 'Admin Akademik', '::1', 'adminakademik', '2025-01-06 14:47:41'),
(174, 'Admin Akademik', '::1', 'admin', '2025-01-06 15:08:50'),
(175, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 15:09:39'),
(176, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 15:22:30'),
(177, 'Admin Akademik', '::1', 'admin', '2025-01-06 15:28:13'),
(178, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 15:28:46'),
(179, 'Admin Kesiswaan', '::1', 'admin', '2025-01-06 15:33:29'),
(180, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 15:33:58'),
(181, 'Nini Ninu', '::1', 'admin', '2025-01-06 15:39:27'),
(182, 'Admin Perpus', '::1', 'admin', '2025-01-06 15:40:11'),
(183, 'Admin Sarpas', '::1', 'admin', '2025-01-06 15:45:56'),
(184, 'Admin PPDB', '::1', 'admin', '2025-01-06 15:47:16'),
(185, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 15:47:38'),
(186, 'Tyas Widyastuti', '::1', 'admin', '2025-01-06 17:11:45'),
(187, 'NOPALL ADMIN UTAMA', '::1', 'admin', '2025-01-06 17:12:11'),
(188, 'Yongki Fajar Mustofa', '::1', 'admin', '2025-01-06 17:14:33'),
(189, 'Umi Latifah', '::1', 'guru', '2025-01-06 17:19:08'),
(190, 'Yongki Fajar Mustofa', '::1', 'admin', '2025-01-06 17:20:11'),
(191, 'Muhamad Rifai Noor Firmansyah', '::1', 'siswa', '2025-01-06 17:29:35'),
(192, 'Yongki Fajar Mustofa', '::1', 'admin', '2025-01-06 17:37:07'),
(193, 'Yongki Fajar Mustofa', '::1', 'admin', '2025-01-07 08:16:21'),
(194, 'Yongki Fajar Mustofa', '::1', 'admin', '2025-01-07 12:41:17'),
(195, 'Muhamad Rifai Noor Firmansyah', '::1', 'siswa', '2025-01-07 12:45:53'),
(196, 'Rizky Dian Rahayu', '::1', 'admin', '2025-01-07 12:48:05'),
(197, 'Muhamad Rifai Noor Firmansyah', '::1', 'siswa', '2025-01-07 12:52:53'),
(198, 'Rizky Dian Rahayu', '::1', 'admin', '2025-01-07 12:53:43'),
(199, 'Nuzulurrochmah', '::1', 'admin', '2025-01-07 12:56:42'),
(200, 'DINI NUR CAHAYA', '::1', 'admin', '2025-01-07 12:58:44'),
(201, 'Zahrotun Nurul Fatmi', '::1', 'admin', '2025-01-07 13:02:54'),
(202, 'Umi Latifah', '::1', 'guru', '2025-01-07 13:06:02'),
(203, 'Muhamad Rifai Noor Firmansyah', '::1', 'siswa', '2025-01-07 13:06:51'),
(204, 'Zahrotun Nurul Fatmi', '::1', 'admin', '2025-01-07 15:05:20'),
(205, 'Tyas Widyastuti', '::1', 'admin', '2025-01-07 15:07:50'),
(206, 'Zahrotun Nurul Fatmi', '::1', 'admin', '2025-01-08 15:28:52'),
(207, 'Umi Latifah', '::1', 'guru', '2025-01-08 15:33:12'),
(208, 'Zahrotun Nurul Fatmi', '::1', 'admin', '2025-01-08 15:34:00'),
(209, 'Umi Latifah', '::1', 'guru', '2025-01-08 15:41:49'),
(210, 'Umi Latifah', '::1', 'guru', '2025-01-08 15:44:41'),
(211, 'Zahrotun Nurul Fatmi', '::1', 'admin', '2025-01-08 15:46:04'),
(212, 'Yongki Fajar Mustofa', '::1', 'admin', '2025-01-09 05:32:55'),
(213, 'opang', '::1', 'admin', '2025-01-09 05:34:16'),
(214, 'Yongki Fajar Mustofa', '::1', 'admin', '2025-01-09 05:35:16'),
(215, 'Zahrotun Nurul Fatmi', '::1', 'admin', '2025-01-09 07:42:39'),
(216, 'DINI NUR CAHAYA', '::1', 'admin', '2025-01-09 07:54:13'),
(217, 'DINI NUR CAHAYA', '::1', 'admin', '2025-01-09 08:14:45');
...
INSERT INTO `mst_admin` (`id`, `nama`, `username`, `password`, `tipe`, `no_wa`) VALUES
(1, 'Yongki Fajar Mustofa', 'adminutama', 'admin', 'root', '62895421113666');
...
(1, '2003040152', '9845749651300032', '2003040152', 'Umi Latifah', '2003040152', 'Perempuan', 'Banyumas', '1971-05-13', 'ISLAM', 'Jalan Pengasinan RT 03/RW 05', NULL, NULL, 'Kedungwringin', 'Patikraja', NULL, '62895421113666', '62895421113666', 'umilatifah1305@gmail.com', 'WNI', '', 2, '1');
...
(25, 'Admin Kesiswaan', '', 'admin'),
(26, 'Admin Sarpas', '', 'admin');
...
(1, 'SMA NEGERI 3 PURWOKERTO', '20302167', '54314854', 'Dusun I, Karangsalam Kidul', 'Karangsalam', 'Kedungbanteng', 'Banyumas', NULL, '53152', '62895421113666', 'https://www.sman3pwt.sch.id', 'smagapwt.official@gmail.com', '8a5b2fa52b2b5e3db12a545812e482ce.png', '-', '-', 'smagaofficial_pwt', '-');
...
INSERT INTO `mst_siswa` (`id_siswa`, `nis`, `nisn`, `nama_siswa`, `jenis_kelamin`, `tempat_lahir`, `tanggal_lahir`, `agama`, `alamat_jalan`, `kelurahan`, `kecamatan`, `kode_pos`, `telepon`, `hp`, `email`, `foto`, `angkatan`, `id_kelas`, `password`, `nama_ayah`, `pendidikan_ayah`, `pekerjaan_ayah`, `no_hp_ayah`, `nama_Ibu`, `pendidikan_ibu`, `pekerjaan_ibu`, `no_hp_ibu`, `nama_wali`, `pendidikan_wali`, `pekerjaan_wali`, `no_hp_wali`, `nama_sekolah`, `status_sekolah`, `alamat_sekolah`, `tahun_lulus`, `aktif_siswa`) VALUES
(1, '2003040154', '2003040154', 'Qania Ramadhani', 'Perempuan', 'Purwokerto', '2007-09-15', 'Islam', 'Kebocoran RT 03 RW 04', 'Kebocoran', 'Kedung Banteng', NULL, '62895421113666', '62895421113666', 'qaniaramadhani@gmail.com', '7fba3bc6c6320e6144638cf681cab42a.jpg', '2021', 1, '2003040154', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1'),
(2, '2003040153', '2003040153', 'Muhamad Rifai Noor Firmansyah', 'Laki-Laki', 'Banyumas, purwokerto', '2007-06-21', 'Islam', 'jl pengasinan rt3 rw 5', 'kedungwringin', 'Patikraja', NULL, '62895421113666', '62895421113666', 'mrsnf00@gmail.com', NULL, '2021', 1, '2003040153', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1'),
(3, '2003040155', '2003040155', 'Naufal', 'Laki-Laki', 'bannyumas', '1970-01-01', 'Islam', 'purwokerto', 'patikraja', 'patikraja', NULL, '62895421113666', '62895421113666', 'ewwy@gmail.com', NULL, '2020', 1, '2003040155', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1');
...
INSERT INTO `mst_user` (`id_user`, `nama`, `username`, `password`, `id_jabatan`, `level`, `no_wa`) VALUES
(5, 'Rizky Dian Rahayu', 'adminkeuangan', 'keuangan', 10, '1', '62895421113666'),
(8, 'Zahrotun Nurul Fatmi', 'adminakademik', 'akademik', 9, '1', '62895421113666'),
(9, 'Tyas Widyastuti', 'adminkesiswaan', 'kesiswaan', 25, '1', '62895421113666'),
(16, 'DINI NUR CAHAYA', 'adminperpus', 'perpus', 20, '1', '62895421113666'),
(18, 'Muchammad Rizal Zulmi', 'adminppdb', 'ppdb', 23, '1', '62895421113666'),
(20, 'Nuzulurrochmah', 'adminsarpras', 'sarpras', 26, '1', '62895421113666');
...
(1, 1, 1, 4, NULL, NULL, NULL, NULL, '2025-01-08 15:42:01'),
(2, 2, 1, 4, NULL, NULL, NULL, NULL, '2025-01-08 15:42:01');
...
(1, 1, 1, 4, NULL, NULL, NULL, '2025-01-08 15:38:32'),
(2, 2, 1, 4, NULL, NULL, NULL, '2025-01-08 15:38:32');
...
(2, 'assessment mingguan', '', '2025-01-08', 1);
...
(1, 1, 1, 4, NULL, NULL, '2025-01-08 15:40:34'),
(2, 2, 1, 4, NULL, NULL, '2025-01-08 15:40:34');
...
(1, 1, 1, 75, 85, NULL, NULL, 87, NULL, NULL, '2025-01-08 15:31:40'),
(2, 1, 2, 75, 80, NULL, NULL, 85, NULL, NULL, '2025-01-08 15:31:40');
...
(0, '62895421113666', 881704, 1736183492),
(0, '62895421113666', 524566, 1736183519),
(0, '62895421113666', 179733, 1736183642),
(0, '62895421113666', 282537, 1736183662),
(0, '62895421113666', 916064, 1736183935),
(0, '62895421113666', 451315, 1736184002),
(0, '62895421113666', 144055, 1736184563),
(0, '62895421113666', 563705, 1736185015),
(0, '62895421113666', 558679, 1736237758),
(0, '62895421113666', 234829, 1736253637),
(0, '62895421113666', 541348, 1736253907),
(0, '62895421113666', 653271, 1736254070),
(0, '62895421113666', 215191, 1736254364),
(0, '62895421113666', 496496, 1736254412),
(0, '62895421113666', 704110, 1736254592),
(0, '62895421113666', 888214, 1736254714),
(0, '62895421113666', 713778, 1736254960),
(0, '62895421113666', 473754, 1736255152),
(0, '62895421113666', 115847, 1736255201),
(0, '62895421113666', 141830, 1736262307),
(0, '62895421113666', 400942, 1736262457),
(0, '62895421113666', 769946, 1736350122),
(0, '62895421113666', 914910, 1736350381),
(0, '62895421113666', 771539, 1736350431),
(0, '62895421113666', 450711, 1736350900),
(0, '62895421113666', 820840, 1736351072),
(0, '62895421113666', 752862, 1736351154),
(0, '62895421113666', 568896, 1736400762),
(0, '62895421113666', 965008, 1736400846),
(0, '62895421113666', 360458, 1736400904),
(0, '62895421113666', 731823, 1736408543),
(0, '62895421113666', 618389, 1736408932),
(0, '62895421113666', 815621, 1736409144),
(0, '62895421113666', 304977, 1736409182),
(0, '62895421113666', 211483, 1736410417);
...
(1, 1, 1, 1, 'Juli', 100000, 0, '0000-00-00'),
(2, 1, 1, 1, 'Agustus', 100000, 0, '0000-00-00'),
(3, 1, 1, 1, 'September', 100000, 0, '0000-00-00'),
(4, 1, 1, 1, 'Oktober', 100000, 0, '0000-00-00'),
(5, 1, 1, 1, 'November', 100000, 0, '0000-00-00'),
(6, 1, 1, 1, 'Desember', 100000, 0, '0000-00-00'),
(7, 1, 1, 1, 'Januari', 100000, 0, '0000-00-00'),
(8, 1, 1, 1, 'Febuari', 100000, 0, '0000-00-00'),
(9, 1, 1, 1, 'Maret', 100000, 0, '0000-00-00'),
(10, 1, 1, 1, 'April', 100000, 0, '0000-00-00'),
(11, 1, 1, 1, 'Mei', 100000, 0, '0000-00-00'),
(12, 1, 1, 1, 'Juni', 100000, 0, '0000-00-00'),
(13, 1, 2, 1, 'Juli', 100000, 0, '0000-00-00'),
(14, 1, 2, 1, 'Agustus', 100000, 0, '0000-00-00'),
(15, 1, 2, 1, 'September', 100000, 0, '0000-00-00'),
(16, 1, 2, 1, 'Oktober', 100000, 0, '0000-00-00'),
(17, 1, 2, 1, 'November', 100000, 0, '0000-00-00'),
(18, 1, 2, 1, 'Desember', 100000, 0, '0000-00-00'),
(19, 1, 2, 1, 'Januari', 100000, 0, '0000-00-00'),
(20, 1, 2, 1, 'Febuari', 100000, 0, '0000-00-00'),
(21, 1, 2, 1, 'Maret', 100000, 0, '0000-00-00'),
(22, 1, 2, 1, 'April', 100000, 0, '0000-00-00'),
(23, 1, 2, 1, 'Mei', 100000, 0, '0000-00-00'),
(24, 1, 2, 1, 'Juni', 100000, 0, '0000-00-00');
...
INSERT INTO `user` (`id`, `nama`, `username`, `password`, `level`, `no_wa`) VALUES
(1, 'Admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', '62895421113666');
...
--
-- Stand-in structure for view `vw_absen`
...
,`keterangan` enum('SAKIT','IZIN','ALPA')
,`tanggal_absen` date
,`alasan` varchar(100)
,`id_guru` int(11)
...
--
-- Stand-in structure for view `vw_ajar_guru`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_bayar_siswa`
-- (See below for the actual view)
--
CREATE TABLE `vw_bayar_siswa` (
`id_pembayaran_bulanan` int(11)
,`id_jenis_pembayaran` int(11)
,`id_kelas` int(11)
,`id_siswa` int(11)
,`tagihan` float
,`bayar` float
,`bulan` varchar(15)
,`tanggal` date
,`nama_pos_keuangan` varchar(100)
,`tahun_ajaran` varchar(9)
,`tipe_pembayaran` enum('Bulanan','Bebas')
,`nama_siswa` varchar(200)
,`nis` varchar(20)
,`nama_kelas` varchar(50)
);
...
--
-- Stand-in structure for view `vw_bayar_siswa_bebas`
-- (See below for the actual view)
--
CREATE TABLE `vw_bayar_siswa_bebas` (
`nama_pos_keuangan` varchar(100)
,`id_pembayaran_bebas` int(11)
,`id_jenis_pembayaran` int(11)
,`id_siswa` int(11)
,`id_kelas` int(11)
,`tahun_ajaran` varchar(9)
...
--
-- Stand-in structure for view `vw_guru_dt`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_jadwal_pelajaran`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_jenis_bayar`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_kepala_sekolah`
-- (See below for the actual view)
--
CREATE TABLE `vw_kepala_sekolah` (
`id_kepala_sekolah` int(11)
,`nip` varchar(30)
,`nik` varchar(50)
,`nama_kepala_sekolah` varchar(60)
,`hp` varchar(15)
,`email` varchar(100)
,`aktif_kepala_sekolah` char(1)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `vw_kepala_sekolah_dt`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_mapel`
-- (See below for the actual view)
--
...
,`aktif_mapel` char(1)
,`kkm` int(2)
,`nama_kelompok_pelajaran` varchar(70)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `vw_pelanggaran_siswa`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_siswa`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_siswa_dt`
-- (See below for the actual view)
--
...
,`tanggal_lahir` date
,`agama` enum('Islam','Katolik','Protestan','Budha','Hindu','Konghucu')
...
,`pekerjaan_wali` varchar(25)
,`no_hp_wali` varchar(15)
,`nama_sekolah` varchar(50)
,`status_sekolah` varchar(15)
,`alamat_sekolah` varchar(250)
...
--
-- Stand-in structure for view `vw_staff`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_staff_dt`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_tarif_kelas`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_tarif_kelas2`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `vw_walikelas`
-- (See below for the actual view)
--
...
--
-- Structure for view `vw_absen`
--
DROP TABLE IF EXISTS `vw_absen`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_absen`  AS  (select `mst_tahun_ajaran`.`tahun_ajaran` AS `tahun_ajaran`,`mst_tahun_ajaran`.`semester` AS `semester`,`mst_siswa`.`nama_siswa` AS `nama_siswa`,`mst_siswa`.`id_siswa` AS `id_siswa`,`mst_siswa`.`nis` AS `nis`,`mst_siswa`.`id_kelas` AS `id_kelas`,`absen`.`id_absen` AS `id_absen`,`absen`.`id_tahun_ajaran` AS `id_tahun_ajaran`,`absen`.`keterangan` AS `keterangan`,`absen`.`tanggal_absen` AS `tanggal_absen`,`absen`.`alasan` AS `alasan`,`absen`.`id_guru` AS `id_guru`,`mst_kelas`.`nama_kelas` AS `nama_kelas` from (((`absen` join `mst_siswa` on((`absen`.`id_siswa` = `mst_siswa`.`id_siswa`))) join `mst_kelas` on((`absen`.`id_kelas` = `mst_kelas`.`id_kelas`))) join `mst_tahun_ajaran` on((`absen`.`id_tahun_ajaran` = `mst_tahun_ajaran`.`id_tahun_ajaran`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_ajar_guru`
--
DROP TABLE IF EXISTS `vw_ajar_guru`;

CREATE ALGORITHM=TEMPTABLE DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_ajar_guru`  AS  (select `mst_mapel`.`nama_mapel` AS `nama_mapel`,`mst_kelas`.`nama_kelas` AS `nama_kelas`,`mst_tahun_ajaran`.`tahun_ajaran` AS `tahun_ajaran`,`mst_tahun_ajaran`.`semester` AS `semester`,`jadwal_pelajaran`.`id_guru` AS `id_guru`,`jadwal_pelajaran`.`id_jadwal_pelajaran` AS `id_jadwal_pelajaran` from (((`jadwal_pelajaran` join `mst_mapel` on((`jadwal_pelajaran`.`id_mapel` = `mst_mapel`.`id_mapel`))) join `mst_kelas` on((`jadwal_pelajaran`.`id_kelas` = `mst_kelas`.`id_kelas`))) join `mst_tahun_ajaran` on((`jadwal_pelajaran`.`id_tahun_ajaran` = `mst_tahun_ajaran`.`id_tahun_ajaran`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_bayar_siswa`
--
DROP TABLE IF EXISTS `vw_bayar_siswa`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_bayar_siswa`  AS  (select `pembayaran_bulanan`.`id_pembayaran_bulanan` AS `id_pembayaran_bulanan`,`pembayaran_bulanan`.`id_jenis_pembayaran` AS `id_jenis_pembayaran`,`pembayaran_bulanan`.`id_kelas` AS `id_kelas`,`pembayaran_bulanan`.`id_siswa` AS `id_siswa`,`pembayaran_bulanan`.`tagihan` AS `tagihan`,`pembayaran_bulanan`.`bayar` AS `bayar`,`pembayaran_bulanan`.`bulan` AS `bulan`,`pembayaran_bulanan`.`tanggal` AS `tanggal`,`mst_pos_keuangan`.`nama_pos_keuangan` AS `nama_pos_keuangan`,`mst_jenis_pembayaran`.`tahun_ajaran` AS `tahun_ajaran`,`mst_jenis_pembayaran`.`tipe_pembayaran` AS `tipe_pembayaran`,`mst_siswa`.`nama_siswa` AS `nama_siswa`,`mst_siswa`.`nis` AS `nis`,`mst_kelas`.`nama_kelas` AS `nama_kelas` from ((((`pembayaran_bulanan` join `mst_jenis_pembayaran` on((`pembayaran_bulanan`.`id_jenis_pembayaran` = `mst_jenis_pembayaran`.`id_jenis_pembayaran`))) join `mst_pos_keuangan` on((`mst_jenis_pembayaran`.`id_pos_keuangan` = `mst_pos_keuangan`.`id_pos_keuangan`))) join `mst_siswa` on((`pembayaran_bulanan`.`id_siswa` = `mst_siswa`.`id_siswa`))) join `mst_kelas` on((`pembayaran_bulanan`.`id_kelas` = `mst_kelas`.`id_kelas`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_bayar_siswa_bebas`
--
DROP TABLE IF EXISTS `vw_bayar_siswa_bebas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_bayar_siswa_bebas`  AS  (select `mst_pos_keuangan`.`nama_pos_keuangan` AS `nama_pos_keuangan`,`pembayaran_bebas`.`id_pembayaran_bebas` AS `id_pembayaran_bebas`,`pembayaran_bebas`.`id_jenis_pembayaran` AS `id_jenis_pembayaran`,`pembayaran_bebas`.`id_siswa` AS `id_siswa`,`pembayaran_bebas`.`id_kelas` AS `id_kelas`,`mst_jenis_pembayaran`.`tahun_ajaran` AS `tahun_ajaran`,`mst_jenis_pembayaran`.`tipe_pembayaran` AS `tipe_pembayaran`,`pembayaran_bebas`.`tagihan` AS `tagihan`,`mst_siswa`.`nama_siswa` AS `nama_siswa`,`mst_siswa`.`nis` AS `nis`,`mst_kelas`.`nama_kelas` AS `nama_kelas` from ((((`pembayaran_bebas` join `mst_jenis_pembayaran` on((`pembayaran_bebas`.`id_jenis_pembayaran` = `mst_jenis_pembayaran`.`id_jenis_pembayaran`))) join `mst_siswa` on((`pembayaran_bebas`.`id_siswa` = `mst_siswa`.`id_siswa`))) join `mst_kelas` on((`pembayaran_bebas`.`id_kelas` = `mst_kelas`.`id_kelas`))) join `mst_pos_keuangan` on((`mst_jenis_pembayaran`.`id_pos_keuangan` = `mst_pos_keuangan`.`id_pos_keuangan`)))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_guru`  AS  (select `mst_guru`.`id_guru` AS `id_guru`,`mst_guru`.`nip` AS `nip`,`mst_guru`.`nik` AS `nik`,`mst_guru`.`nama_guru` AS `nama_guru`,`mst_guru`.`hp` AS `hp`,`mst_guru`.`aktif_guru` AS `aktif_guru`,`mst_jabatan`.`nama_jabatan` AS `nama_jabatan` from (`mst_guru` join `mst_jabatan` on((`mst_guru`.`id_jabatan` = `mst_jabatan`.`id_jabatan`))) order by `mst_guru`.`id_guru` desc) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_guru_dt`
--
DROP TABLE IF EXISTS `vw_guru_dt`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_guru_dt`  AS  (select `mst_guru`.`nip` AS `nip`,`mst_guru`.`nik` AS `nik`,`mst_guru`.`nuptk` AS `nuptk`,`mst_guru`.`nama_guru` AS `nama_guru`,`mst_guru`.`jenis_kelamin` AS `jenis_kelamin`,`mst_guru`.`tempat_lahir` AS `tempat_lahir`,`mst_guru`.`tanggal_lahir` AS `tanggal_lahir`,`mst_guru`.`agama` AS `agama`,`mst_guru`.`alamat_jalan` AS `alamat_jalan`,`mst_guru`.`rt` AS `rt`,`mst_guru`.`rw` AS `rw`,`mst_guru`.`kelurahan` AS `kelurahan`,`mst_guru`.`kecamatan` AS `kecamatan`,`mst_guru`.`kode_pos` AS `kode_pos`,`mst_guru`.`telepon` AS `telepon`,`mst_guru`.`hp` AS `hp`,`mst_guru`.`email` AS `email`,`mst_guru`.`kewarganegaraan` AS `kewarganegaraan`,`mst_guru`.`foto` AS `foto`,`mst_jabatan`.`nama_jabatan` AS `nama_jabatan`,`mst_guru`.`id_guru` AS `id_guru`,`mst_guru`.`id_jabatan` AS `id_jabatan`,`mst_guru`.`aktif_guru` AS `aktif_guru` from (`mst_guru` join `mst_jabatan` on((`mst_guru`.`id_jabatan` = `mst_jabatan`.`id_jabatan`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_jadwal_pelajaran`
--
DROP TABLE IF EXISTS `vw_jadwal_pelajaran`;

CREATE ALGORITHM=TEMPTABLE DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_jadwal_pelajaran`  AS  (select `jadwal_pelajaran`.`id_jadwal_pelajaran` AS `id_jadwal_pelajaran`,`jadwal_pelajaran`.`id_tahun_ajaran` AS `id_tahun_ajaran`,`mst_tahun_ajaran`.`tahun_ajaran` AS `tahun_ajaran`,`mst_tahun_ajaran`.`semester` AS `semester`,`mst_guru`.`nama_guru` AS `nama_guru`,`mst_guru`.`nip` AS `nip`,`mst_kelas`.`nama_kelas` AS `nama_kelas`,`mst_mapel`.`nama_mapel` AS `nama_mapel` from ((((`jadwal_pelajaran` join `mst_guru` on((`jadwal_pelajaran`.`id_guru` = `mst_guru`.`id_guru`))) join `mst_kelas` on((`jadwal_pelajaran`.`id_kelas` = `mst_kelas`.`id_kelas`))) join `mst_mapel` on((`jadwal_pelajaran`.`id_mapel` = `mst_mapel`.`id_mapel`))) join `mst_tahun_ajaran` on((`jadwal_pelajaran`.`id_tahun_ajaran` = `mst_tahun_ajaran`.`id_tahun_ajaran`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_jenis_bayar`
--
DROP TABLE IF EXISTS `vw_jenis_bayar`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_jenis_bayar`  AS  (select `mst_jenis_pembayaran`.`id_jenis_pembayaran` AS `id_jenis_pembayaran`,`mst_jenis_pembayaran`.`tahun_ajaran` AS `tahun_ajaran`,`mst_jenis_pembayaran`.`tipe_pembayaran` AS `tipe_pembayaran`,`mst_jenis_pembayaran`.`aktif_jenis_pembayaran` AS `aktif_jenis_pembayaran`,`mst_pos_keuangan`.`nama_pos_keuangan` AS `nama_pos_keuangan` from (`mst_jenis_pembayaran` join `mst_pos_keuangan` on((`mst_jenis_pembayaran`.`id_pos_keuangan` = `mst_pos_keuangan`.`id_pos_keuangan`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_kepala_sekolah`
--
DROP TABLE IF EXISTS `vw_kepala_sekolah`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_kepala_sekolah`  AS  (select `mst_kepala_sekolah`.`id_kepala_sekolah` AS `id_kepala_sekolah`,`mst_kepala_sekolah`.`nip` AS `nip`,`mst_kepala_sekolah`.`nik` AS `nik`,`mst_kepala_sekolah`.`nama_kepala_sekolah` AS `nama_kepala_sekolah`,`mst_kepala_sekolah`.`hp` AS `hp`,`mst_kepala_sekolah`.`email` AS `email`,`mst_kepala_sekolah`.`aktif_kepala_sekolah` AS `aktif_kepala_sekolah` from `mst_kepala_sekolah` order by `mst_kepala_sekolah`.`id_kepala_sekolah` desc) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_kepala_sekolah_dt`
--
DROP TABLE IF EXISTS `vw_kepala_sekolah_dt`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_kepala_sekolah_dt`  AS  (select `mst_kepala_sekolah`.`id_kepala_sekolah` AS `id_kepala_sekolah`,`mst_kepala_sekolah`.`nip` AS `nip`,`mst_kepala_sekolah`.`nik` AS `nik`,`mst_kepala_sekolah`.`nama_kepala_sekolah` AS `nama_kepala_sekolah`,`mst_kepala_sekolah`.`password` AS `password`,`mst_kepala_sekolah`.`email` AS `email`,`mst_kepala_sekolah`.`hp` AS `hp`,`mst_kepala_sekolah`.`foto` AS `foto`,`mst_kepala_sekolah`.`aktif_kepala_sekolah` AS `aktif_kepala_sekolah` from `mst_kepala_sekolah`) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_mapel`
--
DROP TABLE IF EXISTS `vw_mapel`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_mapel`  AS  (select `mst_mapel`.`id_mapel` AS `id_mapel`,`mst_mapel`.`kode_mapel` AS `kode_mapel`,`mst_mapel`.`nama_mapel` AS `nama_mapel`,`mst_mapel`.`aktif_mapel` AS `aktif_mapel`,`mst_mapel`.`kkm` AS `kkm`,`mst_kelompok_pelajaran`.`nama_kelompok_pelajaran` AS `nama_kelompok_pelajaran` from (`mst_mapel` join `mst_kelompok_pelajaran` on((`mst_mapel`.`id_kelompok_pelajaran` = `mst_kelompok_pelajaran`.`id_kelompok_pelajaran`))) order by `mst_mapel`.`id_mapel` desc) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_pelanggaran_siswa`
--
DROP TABLE IF EXISTS `vw_pelanggaran_siswa`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_pelanggaran_siswa`  AS  (select `mst_siswa`.`nama_siswa` AS `nama_siswa`,`mst_siswa`.`nis` AS `nis`,`mst_kelas`.`nama_kelas` AS `nama_kelas`,`mst_poin_pelanggaran`.`nama_poin_pelanggaran` AS `nama_poin_pelanggaran`,`pelanggaran_siswa`.`id_pelanggaran_siswa` AS `id_pelanggaran_siswa`,`pelanggaran_siswa`.`id_penginput` AS `id_penginput`,`pelanggaran_siswa`.`id_poin_pelanggaran` AS `id_poin_pelanggaran`,`pelanggaran_siswa`.`id_siswa` AS `id_siswa`,`pelanggaran_siswa`.`id_kelas` AS `id_kelas`,`pelanggaran_siswa`.`tanggal` AS `tanggal`,`pelanggaran_siswa`.`poin_minus` AS `poin_minus`,`pelanggaran_siswa`.`tahun_ajaran` AS `tahun_ajaran` from (((`pelanggaran_siswa` join `mst_siswa` on((`pelanggaran_siswa`.`id_siswa` = `mst_siswa`.`id_siswa`))) join `mst_kelas` on((`pelanggaran_siswa`.`id_kelas` = `mst_kelas`.`id_kelas`))) join `mst_poin_pelanggaran` on((`pelanggaran_siswa`.`id_poin_pelanggaran` = `mst_poin_pelanggaran`.`id_poin_pelanggaran`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_siswa`
--
DROP TABLE IF EXISTS `vw_siswa`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_siswa`  AS  (select `mst_siswa`.`nis` AS `nis`,`mst_siswa`.`nama_siswa` AS `nama_siswa`,`mst_siswa`.`jenis_kelamin` AS `jenis_kelamin`,`mst_siswa`.`tanggal_lahir` AS `tanggal_lahir`,`mst_kelas`.`nama_kelas` AS `nama_kelas`,`mst_siswa`.`id_kelas` AS `id_kelas`,`mst_siswa`.`aktif_siswa` AS `aktif_siswa`,`mst_siswa`.`angkatan` AS `angkatan`,`mst_siswa`.`id_siswa` AS `id_siswa` from (`mst_siswa` join `mst_kelas` on((`mst_siswa`.`id_kelas` = `mst_kelas`.`id_kelas`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_siswa_dt`
--
DROP TABLE IF EXISTS `vw_siswa_dt`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_siswa_dt`  AS  (select `mst_siswa`.`id_kelas` AS `id_kelas`,`mst_siswa`.`nis` AS `nis`,`mst_siswa`.`nisn` AS `nisn`,`mst_siswa`.`nama_siswa` AS `nama_siswa`,`mst_siswa`.`jenis_kelamin` AS `jenis_kelamin`,`mst_siswa`.`tempat_lahir` AS `tempat_lahir`,`mst_siswa`.`tanggal_lahir` AS `tanggal_lahir`,`mst_siswa`.`agama` AS `agama`,`mst_siswa`.`alamat_jalan` AS `alamat_jalan`,`mst_siswa`.`kelurahan` AS `kelurahan`,`mst_siswa`.`kecamatan` AS `kecamatan`,`mst_siswa`.`kode_pos` AS `kode_pos`,`mst_siswa`.`telepon` AS `telepon`,`mst_siswa`.`hp` AS `hp`,`mst_siswa`.`email` AS `email`,`mst_siswa`.`foto` AS `foto`,`mst_siswa`.`angkatan` AS `angkatan`,`mst_siswa`.`id_siswa` AS `id_siswa`,`mst_kelas`.`nama_kelas` AS `nama_kelas`,`mst_siswa`.`nama_ayah` AS `nama_ayah`,`mst_siswa`.`pendidikan_ayah` AS `pendidikan_ayah`,`mst_siswa`.`pekerjaan_ayah` AS `pekerjaan_ayah`,`mst_siswa`.`no_hp_ayah` AS `no_hp_ayah`,`mst_siswa`.`nama_Ibu` AS `nama_ibu`,`mst_siswa`.`pendidikan_ibu` AS `pendidikan_ibu`,`mst_siswa`.`pekerjaan_ibu` AS `pekerjaan_ibu`,`mst_siswa`.`no_hp_ibu` AS `no_hp_ibu`,`mst_siswa`.`nama_wali` AS `nama_wali`,`mst_siswa`.`pendidikan_wali` AS `pendidikan_wali`,`mst_siswa`.`pekerjaan_wali` AS `pekerjaan_wali`,`mst_siswa`.`no_hp_wali` AS `no_hp_wali`,`mst_siswa`.`nama_sekolah` AS `nama_sekolah`,`mst_siswa`.`status_sekolah` AS `status_sekolah`,`mst_siswa`.`alamat_sekolah` AS `alamat_sekolah`,`mst_siswa`.`tahun_lulus` AS `tahun_lulus`,`mst_siswa`.`aktif_siswa` AS `aktif_siswa` from (`mst_siswa` join `mst_kelas` on((`mst_siswa`.`id_kelas` = `mst_kelas`.`id_kelas`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_staff`
--
DROP TABLE IF EXISTS `vw_staff`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_staff`  AS  (select `mst_staff`.`id_staff` AS `id_staff`,`mst_staff`.`nip` AS `nip`,`mst_staff`.`nama_staff` AS `nama_staff`,`mst_staff`.`hp` AS `hp`,`mst_staff`.`aktif_staff` AS `aktif_staff`,`mst_jabatan`.`nama_jabatan` AS `nama_jabatan` from (`mst_staff` join `mst_jabatan` on((`mst_staff`.`id_jabatan` = `mst_jabatan`.`id_jabatan`))) order by `mst_staff`.`id_staff` desc) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_staff_dt`
--
DROP TABLE IF EXISTS `vw_staff_dt`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_staff_dt`  AS  (select `mst_staff`.`id_staff` AS `id_staff`,`mst_staff`.`nip` AS `nip`,`mst_staff`.`nama_staff` AS `nama_staff`,`mst_staff`.`password` AS `password`,`mst_staff`.`jenis_kelamin` AS `jenis_kelamin`,`mst_staff`.`tempat_lahir` AS `tempat_lahir`,`mst_staff`.`tanggal_lahir` AS `tanggal_lahir`,`mst_staff`.`agama` AS `agama`,`mst_staff`.`alamat_jalan` AS `alamat_jalan`,`mst_staff`.`rt` AS `rt`,`mst_staff`.`rw` AS `rw`,`mst_staff`.`kelurahan` AS `kelurahan`,`mst_staff`.`kecamatan` AS `kecamatan`,`mst_staff`.`kode_pos` AS `kode_pos`,`mst_staff`.`telepon` AS `telepon`,`mst_staff`.`hp` AS `hp`,`mst_staff`.`email` AS `email`,`mst_staff`.`kewarganegaraan` AS `kewarganegaraan`,`mst_staff`.`foto` AS `foto`,`mst_staff`.`aktif_staff` AS `aktif_staff`,`mst_staff`.`id_jabatan` AS `id_jabatan`,`mst_jabatan`.`nama_jabatan` AS `nama_jabatan` from (`mst_staff` join `mst_jabatan` on((`mst_staff`.`id_jabatan` = `mst_jabatan`.`id_jabatan`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_tarif_kelas`
--
DROP TABLE IF EXISTS `vw_tarif_kelas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_tarif_kelas`  AS  (select `mst_siswa`.`nis` AS `nis`,`mst_siswa`.`nama_siswa` AS `nama_siswa`,`mst_siswa`.`id_kelas` AS `id_kelas`,`mst_kelas`.`nama_kelas` AS `nama_kelas`,`pembayaran_bulanan`.`id_jenis_pembayaran` AS `id_jenis_pembayaran`,`pembayaran_bulanan`.`id_siswa` AS `id_siswa` from ((`pembayaran_bulanan` join `mst_siswa` on((`pembayaran_bulanan`.`id_siswa` = `mst_siswa`.`id_siswa`))) join `mst_kelas` on((`pembayaran_bulanan`.`id_kelas` = `mst_kelas`.`id_kelas`))) group by `pembayaran_bulanan`.`id_siswa`) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_tarif_kelas2`
--
DROP TABLE IF EXISTS `vw_tarif_kelas2`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_tarif_kelas2`  AS  (select `mst_siswa`.`nis` AS `nis`,`mst_siswa`.`nama_siswa` AS `nama_siswa`,`mst_siswa`.`id_kelas` AS `id_kelas`,`mst_kelas`.`nama_kelas` AS `nama_kelas`,`pembayaran_bebas`.`id_jenis_pembayaran` AS `id_jenis_pembayaran`,`pembayaran_bebas`.`tagihan` AS `tagihan`,`pembayaran_bebas`.`id_siswa` AS `id_siswa` from ((`pembayaran_bebas` join `mst_siswa` on((`pembayaran_bebas`.`id_siswa` = `mst_siswa`.`id_siswa`))) join `mst_kelas` on((`pembayaran_bebas`.`id_kelas` = `mst_kelas`.`id_kelas`)))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_walikelas`
--
DROP TABLE IF EXISTS `vw_walikelas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_walikelas`  AS  (select `mst_kelas`.`nama_kelas` AS `nama_kelas`,`mst_walikelas`.`id_kelas` AS `id_kelas`,`mst_walikelas`.`id_walikelas` AS `id_walikelas`,`mst_guru`.`nama_guru` AS `nama_guru`,`mst_walikelas`.`id_guru` AS `id_guru`,`mst_walikelas`.`tahun_ajaran` AS `tahun_ajaran` from ((`mst_walikelas` join `mst_kelas` on((`mst_walikelas`.`id_kelas` = `mst_kelas`.`id_kelas`))) join `mst_guru` on((`mst_walikelas`.`id_guru` = `mst_guru`.`id_guru`)))) ;
...
--
ALTER TABLE `mst_jabatan`
  MODIFY `id_jabatan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `mst_kelompok_pelajaran`
  MODIFY `id_kelompok_pelajaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `mst_pos_keuangan`
  MODIFY `id_pos_keuangan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `nilai_capaian_hasil_belajar`
  MODIFY `id_nilai_capaian_hasil_belajar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `nilai_ekstrakulikuler`
--
ALTER TABLE `nilai_ekstrakulikuler`
  MODIFY `id_nilai_ekstrakulikuler` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `nilai_harian_detail`
  MODIFY `id_nilai_harian_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `pembayaran_bebas`
  MODIFY `id_pembayaran_bebas` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pembayaran_bebas_dt`
--
ALTER TABLE `pembayaran_bebas_dt`
  MODIFY `id_pembayaran_bebas_dt` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pembayaran_bulanan`
--
ALTER TABLE `pembayaran_bulanan`
  MODIFY `id_pembayaran_bulanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
